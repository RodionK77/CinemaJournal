...
import com.example.cinemajournal.data.models.RoomModels.Reviews
...
@Database(entities = [User::class, RoomMovieInfo::class, MoviesToWatch::class, WatchedMovies::class, Reviews::class], version = 1, exportSchema = false)
